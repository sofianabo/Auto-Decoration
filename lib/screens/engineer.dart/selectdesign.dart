...
class SelectDesign extends StatefulWidget {
  const SelectDesign({Key key}) : super(key: key);

  @override
  State<SelectDesign> createState() => _SelectDesignState();
}

class _SelectDesignState extends State<SelectDesign> {
