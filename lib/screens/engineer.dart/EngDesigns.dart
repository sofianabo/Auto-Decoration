...
import '../../Model/EngineerRoomsCompanyModel.dart';
import '../../controllers/api.dart';
String f='s';

class EngDesigns extends StatefulWidget {
  const EngDesigns({Key key}) : super(key: key);

  @override
  State<EngDesigns> createState() => _EngDesignsState();
}

class _EngDesignsState extends State<EngDesigns> {
                    ...
                    children: [
                      ...
                      Center(
                        child: GestureDetector(
                          onTap: () {
                            rr=host+","+port+","+Provider.of<UserInfoProvider>(context,listen: false).token+","+
                                "room2"+","+"8";


                                GetUnityAPI(context).getUntiy("true", rr
                                );
                            Navigator.of(context).pop();
                          },
                          child: Container(
