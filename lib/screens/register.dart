                        ...
                        child: GestureDetector(
                          onTap: (){
                            if(controller[0].text.trim().isNotEmpty &&controller[1].text.trim().isNotEmpty &&
                                controller[2].text.trim().isNotEmpty &&
                                controller[3].text.trim().isNotEmpty &&controller[4].text.trim().isNotEmpty)
                              {
                                login(context).register(controller[0].text.trim(), controller[1].text.trim(),
                                    controller[2].text.trim(), controller[3].text.trim(),
                                    controller[4].text.trim()
                                );
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
