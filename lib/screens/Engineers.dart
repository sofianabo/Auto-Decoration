                        ...
                        child: Container(
                          ...
                          child: AnimatedListView(
                              ...
                              children: List.generate(
                                  Provider.of<EngProvider>(context,listen: true).englist.length,
                                  (index) => GestureDetector(
                                    onTap: (){
                                      EnginnerRoomsCompanyAPI(context).EnginnerRoomsCompany(Provider.of<EngProvider>(context,listen: false).englist.elementAt(index).userName);
                                      Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                              builder: (context) =>
                                            ...
                                            child: Padding(
                                              ...
                                              child: Column(
                                                children: [
                                                  ...
                                                  Text(
                                                    Provider.of<EngProvider>(context,listen: true).englist.elementAt(index).name,
                                                    style: TextStyle(
                                                      fontFamily: 'SpecialElite',
                                                      fontSize: 30,
                                                      color: Color(0xfff484848),
