...
class AddCompanyBranch extends StatefulWidget {
  const AddCompanyBranch({Key key}) : super(key: key);

  @override
  State<AddCompanyBranch> createState() => _AddCompanyBranchState();
}

class _AddCompanyBranchState extends State<AddCompanyBranch> {
                          ...
                          onTap: (){
                            if (controller[0].text.trim().isNotEmpty && controller[1].text.trim().isNotEmpty &&
                              ...
                              var status =AddBranch_Engneer(context).getaddBra_Eng(controller[0].text.trim(),
                                  ...
                                  controller[3].text.trim(), controller[4].text.trim(), 'supCombany');
                              if(status ==200)
                                print('successful');
                            }
                          },
